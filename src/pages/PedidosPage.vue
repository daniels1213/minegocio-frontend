...
<template>
	<section class="orders-page"><div class="heading"><div><p class="eyebrow">Ventas</p><h2>Pedidos</h2><p class="muted">Consulta tus pedidos y actualiza su estado.</p></div><div class="heading-actions"><button class="secondary" type="button" @click="load"><RefreshCw :size="16" /> Actualizar</button><button class="primary" type="button" @click="showOrderModal = true">Añadir pedido</button></div></div>
